...
function nextSlide() {
    carrosselContainer.appendChild(carrosselContainer.firstElementChild.cloneNode(true));
    carrosselContainer.removeChild(carrosselContainer.firstElementChild);

    const carrosselItems = document.querySelectorAll('.carrossel1, .carrossel11, .carrossel111');
